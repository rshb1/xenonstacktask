...
$sql = "INSERT INTO users (email, password, name, address, country, state, city, postal_code, plan) VALUES ( '$email', '$hashed_password', '$name', '$address', '$country', '$state', '$city', '$postal_code', '$plan' )";
